...
const Job = ({ job }) => {
  ...
  return (
    <div
      ...
      className="group bg-white border border-gray-100 rounded-xl p-5 hover:border-[#6A38C2] hover:shadow-md transition-all duration-300 cursor-pointer w-full flex flex-col sm:flex-row gap-4 items-start"
    >
      {/* --- CỘT TRÁI: LOGO --- */}
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-2">
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          {/* Mobile: Salary hiển thị ở đây trên màn hình nhỏ */}
        ...
        {/* Tags / Badges (Giống hình: xám nhạt, bo tròn) */}
        <div className="flex flex-wrap items-center gap-2 mt-1">
          ...
          {/* Experience Badge (Nếu có data experience thì hiển thị ở đây) */}
          {job?.experienceLevel && (
              ...
              <TooltipTrigger asChild>
                <Button
                  ...
                  className={`h-8 w-8 rounded-full transition-colors ${
                    isSaved
                      ? "text-red-500 bg-red-50 hover:bg-red-100" // Đổi sang màu đỏ/hồng giống tim thả trong hình mẫu nếu thích
