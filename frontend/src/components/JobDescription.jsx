...
const JobDescription = ({job}) => {
    ...
    const applyJobHandle = async ()=>{
        try{
            ...
            if(res.data.success){
                setIsApplied(true) // update state local state
    ...
    return (
        <div>
            <NavBar/>
            <div className='max-w-7xl mx-auto pt-[50px] my-10'>
                ...
                <div>
                    ...
                    <h1 className='font-bold my-1'>Requirement: <span className='pl-4 font-normal text-gray-800'>{singleJob?.requirements} year</span></h1>
                    ...
                    <h1 className='font-bold my-1'>Posted Day: <span className='pl-4 font-normal text-gray-800'>{singleJob?.createdAt.split("T")[0]}</span></h1>
                </div>
            </div>
        </div>
    )
