...
const LatestJobCards = ({ job }) => {
  ...
  return (
    <div
      ...
      className="group relative p-5 rounded-2xl bg-white border border-gray-100 shadow-sm cursor-pointer transition-all duration-300 hover:shadow-xl hover:border-[#6A38C2]/30 hover:-translate-y-1 flex flex-col h-full hover:z-50"
    >
      <div className="hidden md:block">
        <JobPopup job={job} position={popupPosition} />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2 mt-auto">
        ...
        <Badge
          variant="secondary"
          className="bg-gray-100 text-gray-600 font-normal px-2 py-1 rounded-md text-xs flex items-center gap-0.5"
        >
